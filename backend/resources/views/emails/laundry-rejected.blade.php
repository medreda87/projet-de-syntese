...
<head>
  ...
  <style>
    ...
    .badge { display: inline-block; background: #fff7ed; color: #f97316; font-size: 13px; font-weight: 700; padding: 6px 14px; border-radius: 99px; margin-bottom: 20px; }
...
<body>
  <div class="card">
    ...
    <div class="badge">⚠️ Needs Review</div>
    <h1>Hi {{ $laundry->user->name ?? 'Provider' }},</h1>
    <p>After reviewing your laundry listing, our team has found that it doesn't currently meet our listing requirements.</p>
    <div class="shop">
      <strong>{{ $laundry->name }}</strong><br>
      <span style="color:#64748b;font-size:14px;">{{ $laundry->address }}</span>
    </div>
    <p>Common reasons include missing services, delivery info, or incomplete profile details. Please update your listing and it will be reviewed again.</p>
    <a href="https://mesbanati.ma/dashboard" class="cta">Update your listing</a>
    <p>If you have questions, please contact our support team at <a href="mailto:support@mesbanati.ma">support@mesbanati.ma</a>.</p>
