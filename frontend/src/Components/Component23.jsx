              ...
              <div 
                ...
                className={`group flex gap-5 transition-all duration-300 ${
                  isProviderVariant 
                    ...
                    : 'bg-white py-4 px-5 rounded-xl shadow-md hover:shadow-lg border border-primary/20 hover:border-primary/40 hover:scale-[1.01]'
                }`}
              >
                {/* Icon Box */}
                <div className={`flex-shrink-0 w-14 h-14 rounded-xl flex items-center justify-center transition-all duration-300 group-hover:scale-110 ${
                  isProviderVariant 
                    ...
                    : 'bg-gradient-to-br from-primary/90 to-primary shadow-md'
                }`}>
